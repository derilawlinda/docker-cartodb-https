...
echo "SELECT CDB_Conf_SetConf('user_config', '{"'"is_organization"'": true, "'"entity_name"'": "'"qlue"'"}');" | psql -U postgres $ORGANIZATION_DB
...
bundle exec  rake cartodb:services:set_org_quota['qlue',geocoding,100000]
